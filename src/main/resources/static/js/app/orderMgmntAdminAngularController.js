angular.module('TestAppAdmin', ['TestAppAdmin.controllers', 'datatables']);

angular.module('TestAppAdmin.controllers', []).controller('adminController', function($scope, $http, DTOptionsBuilder, DTColumnBuilder) {

	$scope.orderMgmntAppApi = "http://localhost:8888/orderMgmnt/hotelOrders/";
	$scope.orderMgmntUsersAppApi = "http://localhost:8888/orderMgmnt/users/2";
	$scope.order={};
	$scope.showEditForm = false;
	$scope.order.orderBy = {};
	$scope.user = {};
	$scope.order.updatedBy="";
